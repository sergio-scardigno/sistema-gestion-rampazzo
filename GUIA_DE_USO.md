...
**3. Se crean tareas y se programan turnos** -- Dentro de la carpeta se asignan las acciones necesarias (turno ANSES, presentacion de documentos, seguimiento, etc.).
...
**Que NO podes hacer:** Crear, editar o eliminar clientes, carpetas, tareas, turnos ni comunicaciones. No tenes acceso a Administracion, Reportes, Auditoria ni Empleados.
...
6. Despues de cada turno: **Marcar Asistido** y cargar el resultado.
7. **Registrar comunicaciones** con los clientes.
